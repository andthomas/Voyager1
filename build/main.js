...
app.init = function(){
  ...
  app.camera.lookAt( app.planetStart[2]["x"], app.planetStart[2]["z"], app.planetStart[2]["y"]);
  app.camera.position.set(-150000,2000,0);
  ...
  app.controls.target.set( app.planetStart[2]["x"], app.planetStart[2]["y"], app.planetStart[2]["z"] );
